...
Marco absorvido fica **aberto com trava de +30d** (resolver faria o detect recriar o alerta toda hora — churn; aberto ele deduplica e a boa notícia nasce da saúde da tela). A queda absorvida fica aberta com **+3d**: é ela que pinta o amarelo da tela.
