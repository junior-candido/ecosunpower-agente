...
2. **Fatia 2 — Tela Financeiro (≈ 10 dias):** (+ pedido do Junior 29/08: aba **"Como funciona"** no dashboard com a explicação em linguagem simples — registrar/lembrar/perguntar, PJ×PF, extrato manda) · 4 cards + abas PJ/PF/Fronteira/A classificar · upload de extrato · importadores Sicoob, Itaú PJ/PF, Santander, LATAM, Visa CSV, Mercado Pago (fila página a página).
