...
const configSchema = z.object({
  ...
  // Formato no env: lista separada por virgula. Ex: "5561998805002,5561993077140"
  // Permite ter pessoal + business como admins simultaneos.
  adminExtraPhones: z.array(z.string()).default([]),
