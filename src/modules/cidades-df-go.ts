// src/modules/cidades-df-go.ts
// Lista hardcoded de municípios do Distrito Federal e Goiás
// Fonte: IBGE (códigos de municípios). DF = Brasília (1 município oficial).
// GO = 246 municípios.

export const CIDADES_DF: string[] = ['Brasília'];

export const CIDADES_GO: string[] = [
  ...
  'Itaguaru', 'Itajá', 'Itapaci', 'Itapirapuã', 'Itapuranga', 'Itarumã',
  'Itauçu', 'Itumbiara', 'Ivolândia', 'Jandaia', 'Jaraguá', 'Jataí',
  'Jaupaci', 'Jesúpolis', 'Joviânia', 'Jussara', 'Lagoa Santa', 'Leopoldo de Bulhões',
  'Luziânia', 'Mairipotaba', 'Mambaí', 'Mara Rosa', 'Marzagão', 'Matrinchã',
  'Maurilândia', 'Mimoso de Goiás', 'Minaçu', 'Mineiros', 'Moiporá',
  'Monte Alegre de Goiás', 'Montes Claros de Goiás', 'Montividiu',
  'Montividiu do Norte', 'Morrinhos', 'Morro Agudo de Goiás', 'Mossâmedes',
  'Mozarlândia', 'Mundo Novo', 'Mutunópolis', 'Nazário', 'Nerópolis',
  'Niquelândia', 'Nova América', 'Nova Aurora', 'Nova Crixás', 'Nova Glória',
...
export const CIDADES_DF_GO: string[] = [...CIDADES_DF, ...CIDADES_GO].sort((a, b) => a.localeCompare(b, 'pt-BR'));
