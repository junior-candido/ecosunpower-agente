  ...
  return [
    {
      ...
      items: [
        ...
        { id: 'menu_fechei', title: '✅ Fechei uma venda', description: 'Toque e escolha o cliente que fechou', action: deps.acaoFecheiVenda },
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'menu_lojas_kitreal', title: '🧰 Kit real (fechado)', description: 'Preço de kit fechado da Sol Fácil (não avulso)', hint: '🧰 Manda */kitreal kWp* (ex: */kitreal 5* · */kitreal 8 micro* · */kitreal 5 go string*) que eu puxo o PREÇO DE KIT REAL da Sol Fácil (kit fechado, não soma de avulso) e já coteio o mais barato.' },
