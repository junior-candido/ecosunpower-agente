...
Saida obrigatoria em JSON valido, sem markdown, sem comentarios:
{
  ...
  "image_prompt": "descricao EM INGLES da imagem (DALL-E 3). REGRAS CRITICAS DE COMPOSICAO: 1) PREFIRA close-ups e macros — fundo desfocado (bokeh) ou fundo liso monocromatico (parede branca, ceu azul liso). 2) ZERO pessoas. ZERO rostos. ZERO maos humanas visiveis. 3) Foco em UM objeto ou cena simples. 4) Composicao MINIMALISTA, espaco negativo generoso. Ideias TOP: close de painel solar com sol refletindo / macro de gota de agua sobre painel / conta de luz sobre mesa de madeira / cofrinho porquinho com moeda de sol / telhado de casa com paineis vista aerea / deserto do cerrado com usina solar no horizonte / medidor de energia digital em close / planta verde crescendo ao lado de painel pequeno / chave de fenda e parafuso sobre painel. EVITE: multidoes, familias, trabalhadores, criancas, grupos, cenas urbanas lotadas, interiores de casa com muitos moveis. Estilo: fotografia profissional tipo Getty Images, iluminacao natural dourada (golden hour), cores quentes e vibrantes, nitidez alta no sujeito principal, fundo desfocado ou limpo. Nunca incluir texto em qualquer idioma."
}`;
