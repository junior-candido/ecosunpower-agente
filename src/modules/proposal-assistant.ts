...
export class ProposalAssistant {
  ...
  private dataToCalculatorInput(data: any): ProposalInput {
    ...
    // absorve creditos. Aceita o alias consumoOutraUnidadeKwh.
    const consumoRemotoRaw = Number(data.consumoRemotoMensalKwh ?? data.consumoOutraUnidadeKwh);
